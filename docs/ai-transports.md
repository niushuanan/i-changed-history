...
| --- | --- | --- | --- | --- |
| 抖音互动空间审核包 | `tt.callAIChatCompletion`，由平台转发至火山方舟 | 抖音平台 AI 服务配置 | `doubao-seed-2-0-lite-260428` | 第一幕固定；后续幕在结果页预取 |
...
- `src/services/deepseek.interactive.test.ts`：互动空间环境验证 `tt.callAIChatCompletion`、官方原始文本 SSE、空流的非流式接管、旧版 provider SSE、平台信息事件、五位业务错误码和固定 Doubao Seed 2.0 Lite。
