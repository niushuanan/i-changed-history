...
export const HISTORY_SEEDS: readonly HistorySeed[] = [
  ...
  moment("shang-yang-356bc", -356, "公元前356年", "商鞅变法", "栎阳秦宫朝堂", "china", "秦孝公案前的法令誊写官", "是否在群臣反对声中盖印颁行县制与军功爵法", "第一批法令将在午时传往各县", "秦孝公任用商鞅推行变法，秦国国力与军事实力迅速增强。", ["秦孝公决意招贤变法", "旧贵族反对按军功授爵", "新法要求县级官吏统一执行"], "变法", "print", P, ["law", "organization"], BOLD),
  ...
  moment("prc-founded-1949", 1949, "1949年10月1日", "新中国成立", "北京天安门城楼", "china", "中央广播事业局的现场播音工程员", "是否在开国大典开始时接通全国广播线路", "毛泽东将在一分钟后宣读中央人民政府公告", "中华人民共和国中央人民政府成立，开国大典通过广播传向全国。", ["中国人民政治协商会议已通过共同纲领", "北平已更名北京并定为首都", "全国多地等待收听开国大典"], "建国", "industry", E, ["technology", "organization"], BOLD),
  ...
  moment("black-death-1347", 1347, "1347年10月", "黑死病抵达欧洲", "西西里墨西拿港检疫码头", "world", "港务会负责靠泊许可的书记", "是否拒绝染疫商船进港并封锁与船员接触的码头", "第一批船员已在跳板前等待下船", "携带瘟疫的船只抵达西西里，黑死病随后席卷欧洲并造成巨大人口损失。", ["来自黑海的船上多人已经死亡", "港口居民尚不清楚疾病传播方式", "商人要求立即卸下粮食与货物"], "疫病", "industry", M, ["medicine", "organization"], CAUTIOUS),
  ...
  moment("circumnavigation-1522", 1522, "1522年9月6日", "首次环球航行", "西班牙桑卢卡尔港外", "world", "维多利亚号掌管航海日志的领航员", "是否在补给耗尽前升起返港信号并提交完整环球航线日志", "退潮将在一个时辰后封住浅水航道", "维多利亚号返回西班牙，完成有记录的首次环球航行。", ["麦哲伦已在菲律宾身亡", "五艘出发船只只剩维多利亚号", "幸存船员长期缺粮患病"], "航海", "exchange", E, ["technology", "writing"], BOLD),
  ...
  moment("un-charter-1945", 1945, "1945年6月26日", "联合国宪章", "旧金山退伍军人纪念馆", "world", "制宪会议核对多语文本的秘书", "是否确认五种文本一致并交各国代表签署宪章", "签字仪式将在午时开始", "五十国代表签署《联合国宪章》，联合国随后正式成立。", ["第二次世界大战接近结束", "各国希望建立新的集体安全机制", "安理会结构与否决权已完成谈判"], "国际", "print", P, ["negotiation", "law"], BALANCED),
  ...
  moment("sputnik-1957", 1957, "1957年10月4日", "首颗人造卫星", "拜科努尔发射场控制掩体", "world", "R-7火箭遥测台的值班工程师", "是否在轨道参数稳定后向莫斯科发送卫星入轨确认", "卫星发射后的第一圈遥测即将结束", "苏联发射斯普特尼克一号，成为首颗进入地球轨道的人造卫星。", ["R-7火箭已完成多次试验", "卫星持续发出可接收的无线电信号", "美苏正在争夺科技与航天优势"], "航天", "space", E, ["technology", "organization"], BOLD),
  moment("oil-crisis-1973", 1973, "1973年10月17日", "石油危机", "科威特石油部长会议厅", "world", "欧佩克阿拉伯成员国的产量记录官", "是否把逐月减产与对特定国家禁运写入会议决议", "各国部长将在一小时后表决", "阿拉伯产油国宣布减产与禁运，国际油价暴涨并冲击全球经济。", ["第四次中东战争正在进行", "西方多国支持以色列", "产油国准备把石油作为外交工具"], "能源", "industry", B, ["business", "negotiation"], BOLD),
