...
export const HISTORY_SEEDS: readonly HistorySeed[] = [
  ...
  moment("prc-founded-1949", 1949, "1949年10月1日", "新中国成立", "北京天安门上空", "china", "开国大典空中梯队的防空指挥员", "是否让受阅战机带实弹兼负首都防空，发现来袭敌机立即脱离队列迎击", "空中梯队将在五分钟后飞越天安门", "中华人民共和国中央人民政府成立；开国大典举行空中阅兵，部分受阅战机同时承担首都防空警戒。", ["国民党空军仍有远程袭击北平的能力", "十七架受阅飞机将飞越天安门", "部分战机带实弹兼负首都防空"], "建国", "industry", E, ["technology", "organization"], BOLD),
  moment("reform-opening-1978", 1978, "1978年12月18日", "改革开放决策", "北京京西宾馆会场", "china", "十一届三中全会文件组的记录员", "是否把工作重点转向经济建设与改革开放写入会议公报", "公报将在闭幕前完成最终表决", "中共十一届三中全会作出把工作重点转向社会主义现代化建设的战略决策，改革开放由此展开。", ["真理标准问题讨论推动思想解放", "农业与城市经济改革已出现地方探索", "与会者正在审议党和国家工作重点"], "改革", "industry", P, ["law", "organization"], BALANCED),
