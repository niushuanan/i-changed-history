...
export const HISTORY_SEEDS: readonly HistorySeed[] = [
  ...
  seed("asante-confederacy", "early-modern", 1701, "库马西，今加纳", false, ["奥塞图图将阿散蒂诸邦组织为联盟", "阿散蒂在1701年击败登基拉并扩大影响", "库马西成为联盟的政治中心"], "如果阿散蒂联盟更早建立成员邦共同议事机制", "国家形成", "revolution"),
  ...
  seed("oapec-oil-embargo", "modern", 1973, "科威特城，科威特", false, ["1973年10月OAPEC部长在科威特城举行会议", "与会国决定立即削减石油产量", "会议声明以供应限制施压支持以色列的国家"], "如果主要经济体当时共同投资可再生能源", "能源与经济", "industry"),
