...
export const POWER_CATALOGUE = [
  ...
  { id: "summon-future-self", name: "让时间暂停三十秒", category: "time", rule: "你能让自己之外的整个现场完全暂停三十秒，只有你可以在暂停中自由行动", duration: "主观三十秒" },
  { id: "borrow-tomorrow-memory", name: "加速一件事", category: "time", rule: "你能让一件正在发生或二十四小时内注定会发生的事立即完成", duration: "加速结果永久存在" },
  ...
  { id: "reverse-cause", name: "取消一件事", category: "causality", rule: "你能把现场一件已经发生的具体行动或命令变为从未发生过，所有人只接受新事实", duration: "取消结果永久存在" },
