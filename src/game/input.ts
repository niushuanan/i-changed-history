...
const MODERN_CHINA_ENTITY_LEXICON = {
  yearGated: {
    ...
    majorPrefectureCities: ["广州", "苏州", "无锡", "宁波", "温州", "佛山", "东莞", "泉州", "厦门", "深圳", "青岛", "大连", "沈阳", "哈尔滨", "南京", "武汉", "西安", "杭州", "福州", "长沙", "成都", "昆明", "拉萨", "乌鲁木齐", "呼和浩特", "银川", "洛阳", "开封", "保定", "唐山", "烟台", "徐州", "南通", "嘉兴", "金华", "绍兴", "合肥", "南昌", "济南", "郑州", "太原", "石家庄", "贵阳", "兰州", "西宁"],
    historicalTerms: ["清朝", "清代", "清廷"],
  },
  modernContexts: ["近现代", "当代", "现代"],
  alwaysModern: {
    politicalEntities: ["中华人民共和国", "中华民国", "民国", "新中国", "国民政府", "北洋政府", "中共中央", "中国共产党", "国民党", "人民解放军"],
    post1840HistoricalReferences: ["太平天国", "洋务运动", "清末", "晚清", "北洋", "辛亥革命", "二次革命", "护国运动", "北伐战争", "九一八事变", "西安事变", "香港回归", "澳门回归"],
