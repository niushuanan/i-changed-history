...
function turnContract() {
  return {
    ...
    rules: {
      ...
      narrative: "88 个汉字以内，必须用两个句号写成恰好两句，第二人称现在时。第一幕第一句交代著名历史前情，第二句交代眼前冲突；续幕第一句说明上一项决定如何造成当前局面，第二句交代真实人物的当前意图、一个可见物件和迫近冲突",
      headline: "22 个汉字以内",
      ...
      causalBridge: "56 字以内；第一幕说明玩家决定如何成为时间线源头；续幕明确写出上次结果通过何种人物、命令、交通、制度或物件传到本幕新冲突",
      turningPointStakes: "44 字以内；说明本幕将不可逆地决定的重大秩序与主要受影响者",
      worldStateChange: "56 字以内；只写当前架空时间线已经落地的新事实，不得混入真实历史",
      divergenceProof: "72 字以内；只写真实历史实际发生的结果和直接后果，字段正文不要重复写‘真实历史中’，不得复述当前架空线；必须含至少一个可核验的真实人物、机构、地点或事件，由前端与 worldStateChange 明确对照",
