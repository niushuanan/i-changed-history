...
function turnContract() {
  return {
    ...
    rules: {
      ...
      narrative: "80-160 个汉字，用二至五句完整叙事交代三层信息，推荐三句，第二人称现在时。第一层交代著名史实局面或上一项决定如何造成当前局面；第二层写明真实人物、机构或阵营正在争夺什么及现场可见证据；第三层写清你能调动的身份或资源、必须决定什么、失败会立即失去什么",
      ...
      causalBridge: "30 字以内；不复述玩家的选择；只写上次结果通过何种人物、命令、交通、制度或物件造成本幕局面",
