...
function turnContract() {
  return {
    ...
    rules: {
      ...
      causalBridge: "36 字以内；不复述玩家的选择；只写上次结果通过何种人物、命令、交通、制度或物件造成本幕局面",
      turningPointStakes: "44 字以内；说明本幕将不可逆地决定的重大秩序与主要受影响者",
      worldStateChange: "36 字以内；一句话只写当前架空时间线已经落地的最关键新事实，不得混入真实历史",
      divergenceProof: "48 字以内；一句话只写真实历史的对应结果，字段正文不要重复写‘真实历史中’，不得复述当前架空线；必须含至少一个可核验的真实人物、机构、地点或事件",
